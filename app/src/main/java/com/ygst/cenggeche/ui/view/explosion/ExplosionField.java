package com.ygst.cenggeche.ui.view.explosion;
...
//        }
     ...
     */
    public void addListener(View view, boolean isGone) {
        if (view instanceof ViewGroup) {
            ViewGroup viewGroup = (ViewGroup) view;
            int count = viewGroup.getChildCount();
            for (int i = 0; i < count; i++) {
                addListener(viewGroup.getChildAt(i), isGone);
            }
        } else {
            view.setClickable(true);
            view.setOnClickListener(getOnClickListener(isGone));
        }
    }


    private OnClickListener getOnClickListener(final boolean isGone) {
        if (null == onClickListener) {
            ...
            onClickListener = new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isGone) {
                        v.setVisibility(View.INVISIBLE);//用过一次就让它消失了
                    }
